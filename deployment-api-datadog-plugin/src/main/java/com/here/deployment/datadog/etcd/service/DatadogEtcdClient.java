...
*/
package com.here.deployment.datadog.etcd.service;
...
/**
 * The Interface DatadogEtcdClient.
 */
public interface DatadogEtcdClient {
	 ...
	 */
	PluginResponse sendToEtcd(EtcdConfiguration etcdConfiguration);
}
