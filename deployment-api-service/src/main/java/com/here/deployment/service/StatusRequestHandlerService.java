...
/**
 * The Interface StatusRequestHandlerService.
 */
public interface StatusRequestHandlerService {
	 ...
	 */
	ResponseEntity<? extends AppStatusResponse> handleStatusRequest(AppStatusRequest appStatusRequest);
}
